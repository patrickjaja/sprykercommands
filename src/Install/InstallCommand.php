...
class InstallCommand extends AbstractCommand
{
    ...
    private function pullImages(InputInterface $input, OutputInterface $output): void {
    ...
    private function createVolumes(InputInterface $input, OutputInterface $output): void {
    ...
    private function buildLocalImages(InputInterface $input, OutputInterface $output): void {
        $output->writeln($this->getFacade()->runShell($this->build . ' ./env -t nxs-docker-dumper'));
    }

    private function pushCode(InputInterface $input, OutputInterface $output): void {
    ...
    private function startContainer(InputInterface $input, OutputInterface $output): void {
    ...
    private function prepareInstallApp(InputInterface $input, OutputInterface $output): void {
    ...
    private function addRabbitMqUsers(InputInterface $input, OutputInterface $output): void {
        foreach ($this->stores as $store) {
    ...
    private function restoreServiceData(InputInterface $input, OutputInterface $output): void {
    ...
    private function installApp(InputInterface $input, OutputInterface $output): void
    {
    ...
    private function installationComplete(InputInterface $input, OutputInterface $output): void {
